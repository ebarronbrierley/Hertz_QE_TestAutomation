...
namespace HertzNetFramework.Tests.SOAP
{
    ...
    class BuyTier : BrierleyTestFixture
    {
        ...
        public void TestBuyTier()
        {
            ...
            {
                decimal points = 3300;
                string code = "19BuyTierMaintainPC6500Reg";
                ...
                Member buyTierMember = Member.GenerateRandom(MemberStyle.PreProjectOne, null, new HertzTier("Presidents Circle", "PC", 0.5M)).Set("N1", "MemberDetails.A_EARNINGPREFERENCE").Set("PC", "MemberDetails.A_TIERCODE").Set("BE", "MemberDetails.A_COUNTRY");
                //Member buyTierMember = Member.GenerateRandom(MemberStyle.ProjectOne).Set("N1", "MemberDetails.A_EARNINGPREFERENCE").Set("PC", "MemberDetails.A_TIERCODE").Set("GB", "MemberDetails.A_COUNTRY");
